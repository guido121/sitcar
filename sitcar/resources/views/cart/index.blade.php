...
@section('content')
           ...
           <h1> {{ Str::ucfirst(__('validation.attributes.cart'))}}</h1>
           <div class="row" style="margin-top:10px">
                <div class="col-md-4">
                    <form class="form-inline search-form" action="{{ route('cart.index') }}" method="GET">
                        @csrf
           ...
           <a href="{{ route('cart.create') }}" class="btn btn-primary">{{ Str::ucfirst(__('validation.attributes.new'))}}</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="table-buttons d-flex">
                        <a href="{{ route('cart.edit',$c->id) }}" class="btn btn-info btn-sm">
